...
class BaseDataset(Dataset):
    ...
    def retrieve_base_data(self, idx, cur_ego_pose_flag=True, uni_time_delay=-1, model_type='IoSICP'):
        """
        ...
        for cav_id, cav_content in scenario_database.items():
            ...
            # if model_type == 'IoSICP' and not self.train and timestamp_delay>=3:
            #     continue
